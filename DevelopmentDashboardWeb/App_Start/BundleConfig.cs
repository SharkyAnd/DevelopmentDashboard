    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/SettingsScripts").Include(
                        "~/Scripts/Administration/settings.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/SettingsCss").Include("~/Content/administration/settings.css", "~/Content/font-awesome.css"));    
        }
    }
}