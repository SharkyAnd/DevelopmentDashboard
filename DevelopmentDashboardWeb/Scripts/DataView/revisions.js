var revisionsGridOptions = {
    ...
    columns: [
        ...
        { dataField: "RepositoryName", allowGrouping: true },        
        {
            dataField: "Moment",
            dataType: "date",
            ...
            { dataField: "UserId", allowGrouping: false },
    ...
    summary: {
        groupItems: [{
            column: "Id",
            summaryType: "count",
            displayFormat: "{0} total revisions"
        }
                ]
    },
    columnChooser: {
...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            dataGrid = $('#gridContainer').dxDataGrid(revisionsGridOptions).dxDataGrid("instance").option("dataSource", data);
        }
    });
});